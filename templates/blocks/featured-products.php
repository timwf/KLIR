  ...
  <div class="featured-products__inner container">
    ...
    <div class="featured-products__wrap">
      ...
      <div class="featured-products__image">
          <?php _get_template_part('templates/components/_resp-img', ['field' => $featured_product_one['image'], 'class' => 'featured-products__image-hidden', 'sizes' => '(max-width: 1023px) 100vw, 950px']); ?>
          <?php _get_template_part('templates/components/_resp-img', ['field' => $featured_product_one['hidden_image'], 'class' => 'featured-products__image-show ', 'sizes' => '(max-width: 1023px) 100vw, 950px']); ?>
        </div>
      ...
      <div class="featured-products__right">
        <div class="featured-products__image">
          <?php _get_template_part('templates/components/_resp-img', ['field' => $featured_product_two['image'], 'class' => ' featured-products__image-hidden', 'sizes' => '(max-width: 1023px) 100vw, 950px']); ?>
          <?php _get_template_part('templates/components/_resp-img', ['field' => $featured_product_two['hidden_image'], 'class' => 'featured-products__image-show', 'sizes' => '(max-width: 1023px) 100vw, 950px']); ?>
        </div>
